defmodule BeamCampusWeb.NeuralCoevolutionLive do
  ...
  @traj [
    %{gen: 0, p: 0.35, e: 0.6, cofit: 0.0},
    %{gen: 1, p: 0.95, e: 0.85, cofit: 1.0},
    %{gen: 2, p: 0.95, e: 0.85, cofit: 1.0},
    %{gen: 3, p: 1.0, e: 0.85, cofit: 1.0},
    %{gen: 4, p: 0.95, e: 0.85, cofit: 1.0},
    %{gen: 5, p: 0.9, e: 0.65, cofit: 0.0},
    %{gen: 6, p: 1.0, e: 0.7, cofit: 1.0},
    %{gen: 7, p: 0.95, e: 0.65, cofit: 1.0},
    %{gen: 8, p: 0.95, e: 0.85, cofit: 1.0},
    %{gen: 9, p: 0.95, e: 0.8, cofit: 1.0},
    %{gen: 10, p: 0.95, e: 0.7, cofit: 1.0},
    %{gen: 11, p: 0.8, e: 0.75, cofit: 1.0},
    %{gen: 12, p: 1.0, e: 0.75, cofit: 1.0},
    %{gen: 13, p: 0.9, e: 0.45, cofit: 1.0},
    %{gen: 14, p: 0.9, e: 0.7, cofit: 1.0},
    %{gen: 15, p: 0.9, e: 0.85, cofit: 1.0},
    %{gen: 16, p: 0.9, e: 0.85, cofit: 1.0},
    %{gen: 17, p: 0.9, e: 0.85, cofit: 1.0},
    %{gen: 18, p: 1.0, e: 0.85, cofit: 1.0},
    %{gen: 19, p: 0.9, e: 0.9, cofit: 1.0},
    %{gen: 20, p: 1.0, e: 0.85, cofit: 1.0},
    %{gen: 21, p: 1.0, e: 0.85, cofit: 1.0},
    %{gen: 22, p: 0.9, e: 0.85, cofit: 1.0},
    %{gen: 23, p: 1.0, e: 0.85, cofit: 1.0},
    %{gen: 24, p: 0.9, e: 0.85, cofit: 1.0},
    %{gen: 25, p: 0.95, e: 0.85, cofit: 1.0},
    %{gen: 26, p: 0.95, e: 0.85, cofit: 1.0},
    %{gen: 27, p: 0.95, e: 0.85, cofit: 1.0}
  ]
  @path [
    {{0, 0}, {4, 4}},
    {{1, 0}, {4, 5}},
  ...
  def mount(_params, _session, socket) do
    {:ok,
     assign(socket, w: @w, traj: @traj, path: @path, idx: 0, playing: false, len: length(@path))}
  end
  ...
  def handle_event("play", _p, socket) do
    cond do
      ...
      socket.assigns.idx >= socket.assigns.len - 1 ->
        {:noreply, socket |> assign(idx: 0) |> start()}
    ...
    <Layouts.app flash={@flash}>
      <div class="mx-auto max-w-4xl px-6 py-16">
        ...
        <div class="alert bg-base-200 border border-base-300 text-sm mb-6">
          <span>
            <b>This is the real engine.</b>
            Two populations of faber-tweann networks coevolve on a
            torus; every move is a live forward pass. It is the honest counterpart to the <.link
              navigate={~p"/research/workbench/red-queen"}
              class="link"
            >numerical Red Queen</.link>,
        ...
        <p class="text-base-content/70 max-w-2xl mb-6">
          ...
          learns to catch, then <b>dominates</b>: the evader's gradient dies. That is <b>disengagement</b>, one of the three coevolution outcomes, and it is why a genuine
          ...
          <div class="card bg-base-100 border border-base-300">
            <div class="card-body p-4 gap-2">
              ...
              <p class="font-mono text-[11px] text-base-content/50 mt-1">
                ...
                pursuer (1.5× speed) &nbsp; <span class="text-success">●</span>
                evader
              </p>
            </div>
          </div>
        ...
        <div class="card bg-base-100 border border-base-300 mt-6">
          <div class="card-body gap-3">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-2 font-mono text-xs text-base-content/50 pt-1">
              <a
                href="https://github.com/rgfaber/faber-ecosystem/blob/master/plans/CHARTER_P7_COEVOLUTION.md"
              ...
              <a
                ...
                rel="noreferrer"
              >
                signed insights 053-057
              </a>
              <.link navigate={~p"/research/notes/two-nets-learn-to-chase"} class="link link-hover">
  ...
  defp arena(assigns) do
    ...
    <svg
      ...
      class="w-full h-auto"
      role="img"
      aria-label="A torus grid with a pursuer and an evader network."
    >
      <rect
        x={@pad}
        y={@pad}
      ...
      <circle
        :if={@caught}
        cx={cx(elem(@pursuer, 0))}
        cy={cy(elem(@pursuer, 1), @w)}
        r={@cell / 2}
        fill="#C7583F"
        opacity="0.25"
      />
  ...
  defp curves(assigns) do
    ...
    line = fn key ->
      Enum.map_join(assigns.traj, " ", fn f -> "#{gx(f.gen, n)},#{vy(Map.fetch!(f, key))}" end)
    end
    ...
    <svg
      ...
      class="w-full h-auto"
      role="img"
      aria-label="Coevolution progress curves: flat, pinned head-to-head, no arms race."
    >
