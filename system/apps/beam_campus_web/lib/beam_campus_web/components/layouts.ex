defmodule BeamCampusWeb.Layouts do
  @moduledoc """
  ...
  def app(assigns) do
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8 border-b border-base-300/60">
      <div class="flex-1">
        <a href="/" class="flex w-fit items-center gap-2" aria-label="BEAM Campus home">
          <img src={~p"/images/beam-campus-horizontal.svg"} alt="BEAM Campus" class="h-9 w-auto" />
        </a>
      </div>
      <div class="flex-none">
